#analyses for Ng protein expression

library(lme4)
# importin data
data = read.csv("ng.csv")
...
time1$Intensity <- time1$Intensity/6073819.75
time2$Intensity <- time2$Intensity/6376191.3333
time3$Intensity <- time3$Intensity/6869282.3
